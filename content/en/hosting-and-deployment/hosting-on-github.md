...
1. You use `<USERNAME>.github.io` to host your content
2. Content from the `main` branch will be used to publish your GitHub Pages site unless you configure it.

This is a much simpler setup as your Hugo files and generated content are published in two different branches, `main` and `gh-pages`.

`gh-pages` will store your generated HTML, and `main` will have your Hugo content.

## Build Hugo With GitHub Action

GitHub will automatically execute your software development workflows. Everytime you push your code on your Github repository, Github Actions will build the site and push it to the `gh-pages` branch.
    ...
    steps:
      ...
      - name: Deploy
        ...
        with:
          ...
          publish_dir: ./public # Hugo's build directory. It will be pushed to the gh-pages branch.
```
