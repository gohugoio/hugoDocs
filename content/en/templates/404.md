...
* Azure Static Website Hosting in Azure Storage. You can specify a custom 404 page. [Details here](https://docs.microsoft.com/en-us/azure/storage/blobs/storage-blob-static-website)
{{% note %}}
