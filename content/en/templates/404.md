...
{{% note "Type of 404 page" %}}
Hugo's Custom 404 pages are of the "type" node. If you need to pass front matter parameters to the 404 page from a `404.md` you will need to organize that content file and the respective template as you would do for a section. See [Hugo's Lookup Order](https://gohugo.io/templates/lookup-order/#readout)
{{% /note %}}
