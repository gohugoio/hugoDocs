...
See [template lookup order][] to learn how to target shortcode templates by content path, page kind, language, and output format.
...
Examine the source code of Hugo's [embedded shortcodes][source code] for additional examples.
...
[source code]: https://github.com/gohugoio/hugo/tree/master/tpl/tplimpl/embedded/templates/_shortcodes
