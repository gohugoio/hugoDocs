...
Hugo will automatically create pages for each *root section* that list all the content in that section. See the documentation on [section templates][] for details on customizing the way these pages are rendered.
