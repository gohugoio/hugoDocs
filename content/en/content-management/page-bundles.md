...
| Allowed Resources                   | Page and non-page (like images, pdf, etc.) types         | For top-level home page, only non-page (like images, pdf, etc.) types. Othere branch bunbles can have page and non-page types.                                                                                                                                                                       |
