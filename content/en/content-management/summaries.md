...
To access a summary that you define in the front matter, you must call the `.Params.summary` page variable. Calling `.Summary` will only return a summary that was generated by automatic summary split or manual summary split.
