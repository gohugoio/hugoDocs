...
title: Page Objects
linktitle:
description: Page-level objects are defined in a content file's front matter, derived from the content's file location, or extracted from the content body itself.
date: 2017-02-01
...
{{% note "`.Scratch`" %}}
See [`.Scratch`](/objects/page/scratch/) for page-scoped, writable variables.
{{% /note %}}
