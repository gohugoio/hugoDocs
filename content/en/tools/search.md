...
* [JS & Fuse.js tutorial](https://makewithhugo.com/add-search-to-a-hugo-site/) A simple client-side search solution, using FuseJS. Similar to the eddieweb link above, but does not require jQuery.
