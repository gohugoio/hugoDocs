...
frontmatter
: See [configure front matter](/configuration/frontmatter/).
...
HTTPCache
: See [configure HTTP cache](/configuration/httpcache/).
...
mediaTypes
: See [configure media types](/configuration/mediatypes/).
...
outputFormats
: See [configure output formats](/configuration/outputFormats/).
...
related
: See [configure related content](/configuration/related/).
...
uglyurls
: See [configure ugly URLs](/configuration/uglyurls/).
...
[default front matter configuration]: /configuration/frontmatter/
