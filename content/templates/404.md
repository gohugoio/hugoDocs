...
{{% note %}}
**Note:** At the moment, `hugo server` is not capable of serving a custom 404 page, and will display a generic `404 page not found` message instead. While this issue is being resolved, you will have to supply your own web server in order to test your custom 404 page during development.
{{% /note %}}
